                    ...
                    <tbody>
                      <tr>
                        <td class="column column-1"
                                ...
                                <td class="pad"
                                  ...
                                  <h3
                                    ...
                                    <span class="tinyMce-placeholder">
                                      Tu solicitud de sala ha sido cancelada
                                    </span>
                                  </h3>
                                </td>
                              </tr>
                                ...
                                <td class="pad">
                                  <div
                                    ...
                                    <p style="margin: 0; margin-bottom: 16px;">
                                      Te enviamos los detalles de la sala que cancelaste:</p>
                                ...
                                <td class="pad">
                                  <div
                                    ...
                                    <p style="text-align: center; margin: 0; margin-bottom: 16px;">
                                      Si deseas <strong>solicitar</strong> nuevamente otra sala, debes hacerlo a
                                      través de la página
                                      oficial o presencialmente en Coordinación Docente.
                                    </p>
                          ...
                          <div class="spacer_block block-4" style="height:30px;line-height:30px;font-size:1px;">&#8202;
                          </div>
                        </td>
                      </tr>
                    </tbody>
