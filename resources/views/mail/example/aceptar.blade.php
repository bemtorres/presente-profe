...
<body style="background-color: #fff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
  <table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
    ...
    <tbody>
      <tr>
        <td align="center"
          style="font-family:'Open Sans',Arial,helvetica,sans-serif; font-size:11px;text-decoration: none;padding: 20px;" valign="middle"><br><br><br><br>&nbsp;
        </td>
      </tr>
      <tr>
        <td>
                                ...
                                <td class="pad"
                                  ...
                                  <h3
                                    ...
                                    <span class="tinyMce-placeholder">
                                      Tu solicitud de sala ha sido aprobada
                                    </span>
                                  </h3>
                                </td>
                              </tr>
                                    ...
                                    <p style="margin: 0; margin-bottom: 16px;">
                                      ...
                                      <span style="background-color: transparent;">
                                        <ul>
                                          ...
                                          <li><strong>Fecha Solicitud:</strong> Viernes 3 de Noviembre 2023</li>
