...
<head>
  ...
  <meta property="og:title" content="Recuperacion de contraseña">
</head>
...
<body style="background-color: #fff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
  <table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
    ...
    <tbody>
      <tr>
        <td align="center"
          style="font-family:'Open Sans',Arial,helvetica,sans-serif; font-size:11px;text-decoration: none;padding: 20px;"
          valign="middle"><br><br><br><br>
          &nbsp;</td>
      </tr>
      <tr>
        <td>
                              ...
                              <tr>
                                <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                  <div align="center" class="alignment" style="line-height:10px"><img
                                      src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/820540_804481/logo_duoc_color.png"
                                      style="display: block; height: auto; border: 0; max-width: 233.33333333333331px; width: 100%;"
                                      width="233.33333333333331"></div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                            ...
                            <tbody>
                              <tr>
                                <td class="pad" style="text-align:center;width:100%;">
                                  <h1
                                    style="margin: 0; color: #393d47; direction: ltr; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; font-size: 23px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: right; margin-top: 0; margin-bottom: 0;">
                                    <span class="tinyMce-placeholder">Comparte Duoc UC</span>
                                  </h1>
                                </td>
                              </tr>
                            </tbody>
                          ...
                          <table border="0" cellpadding="10" cellspacing="0" class="paragraph_block block-2"
                            ...
                            <tbody>
                              <tr>
                                <td class="pad">
                                  <div
                                    style="color:#000000;direction:ltr;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;font-size:20px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:justify;mso-line-height-alt:19.2px;">
                                    <p style="margin: 0; margin-bottom: 16px;">
                                      Hemos recibido una solicitud para restablecer la contraseña asociada a tu cuenta.
                                      Se ha asignado una nueva contraseña temporal, la cual deberás cambiar al iniciar
                                    </p>
                                    ...
                                    <p style="margin: 0; margin-bottom: 16px;">
                                      ...
                                      <span style="background-color: transparent;">
                                        <ul>
                                          ...
                                          <li><strong>Correo: </strong>{{ $params['email'] }} </li>
                                    ...
                                    <p style="margin: 0; margin-bottom: 16px;">
                                      ...
                                      <a href="{{ route('root') }}">Comparte Duoc UC</a>
                                    </p>
                                  </div>
                                </td>
                              </tr>
                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="padding:0 5px 0 5px;"><a
                                              href="https://trackercl1.fidelizador.com/L10EC7010GC4615D34H10B417A1B31D5CJ10B44AC2F512K10EC7010992AE79FC3F18CE42EF12BDB2B"
                                  ...
                                  <div style="font-family: sans-serif">
                                    <div
                                      ...
                                      <p
                                        ...
                                        Copyright &copy; 2023 Comparte Duoc UC, Todos los derechos reservados.</p>
