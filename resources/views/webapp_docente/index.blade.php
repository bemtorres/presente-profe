...
<div class="row g-4">
  @foreach ($espacios as $e)
    <div class="col-12 col-md-4 col-xl-3 col-xxl-2">
      <div class="app-card app-card-doc shadow h-100 handle" onclick="window.location='{{ route('webappdocente.espacios.show', $e->id) }}'">
        ...
        <div class="app-card-body p-3 has-card-actions">
          ...
          <div class="d-grid gap-2 mt-2">
            <a href="{{ route('webappdocente.espacios.show', $e->id) }}" class="btn btn-info btn-lg">
              INGRESAR
            </a>
...
@include('webapp_docente._modal_crear_espacio')
@endsection
