...
<div class="container-fluid">
  @component('components.button._back')
    ...
    @slot('body', 'Carga masiva de usuarios')
  @endcomponent
    ...
    <div class="card-body row">
      <div class="col-md-6">
        <div class="card shadow mb-3">
          <div class="card-body">
            <form class="form-sample form-submit" action="{{ route('utils.usuarios') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="row mb-3">
      ...
      <div class="col-md-6">
        <div class="card shadow mb-3">
          <div class="card-body">
            <p>Carga masiva de usuarios mediante excel</p>

            <p>El archivo excel debe tener la siguiente estructura:</p>
            <a href="{{ asset('template/excel/TEMPLATE_USUARIO.xlsx') }}">Descargar excel de usuarios</a>
          </div>
        </div>
      </div>
    </div>
